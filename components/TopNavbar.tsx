        ...
        <div>
            <Navbar fluid className='bg-black text-white py-5'>
                ...
                <NavbarCollapse className='place-self-center'>
                    ...
                    <NavbarLink className='me-6 self-center text-white text-xl' href="#">Skills</NavbarLink>
                    <NavbarLink className='me-6 self-center text-white text-xl' href="#">Projects</NavbarLink>
