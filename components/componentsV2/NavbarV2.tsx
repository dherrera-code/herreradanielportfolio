        ...
        <div className='sticky top-0 z-50 border border-gray-900 shadow-lg'>
            <Navbar fluid className='bg-white text-gray-800 py-2'>
                ...
                <NavbarCollapse>
                    ...
                    <a download='/HerreraDResumeCodestack.pdf' href='./HerreraDResumeCodestack.pdf' className='bg-[#1F108E] px-5 py-2 rounded-xl text-center text-white text-lg block md:hidden'>Resume</a>
                </NavbarCollapse>
                <div className='md:block hidden'>
                    <div className='flex gap-5 '>
                        ...
                        <a title='Click to download resume!' download='./HerreraDResumeCodestack.pdf' href='./HerreraDResumeCodestack.pdf' className='bg-[#1F108E] px-5 py-2 rounded-xl text-white text-lg'>Resume</a>
                    </div>
                </div>
            </Navbar>
        </div>
